...
#define m_dwEpochTime 1600195426

#define m_dwLocalPlayer 0xD3AC5C
#define m_dwEntityList 0x4D4F1FC
#define m_dwClientState 0x589DD4
#define m_dwPlayerResource 0x317EAE0
#define m_dwForceAttack 0x3180754
#define m_dwForceAlt1 0x51F8E50
#define m_dwForceJump 0x51F8E14
#define m_dwSensitivity 0xD4069C
#define m_dwGlowObject 0x5296FB0
